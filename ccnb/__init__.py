...
def get_bvse(filename_cif, moveion='Li', valenceofmoveion=1, resolution=0.1):
    ...
    """
    barrier = bv_calculation(filename_cif, moveion=moveion, valenceofmoveion=valenceofmoveion, resolution=resolution)
    return barrier
...
def get_non_equivalent_paths_between_latticesite(filename_CIF, filename_BVSE, filename_CAVD, energythreshold, moveion='Li'):
    ...
    :param filename_CAVD: net filename
    :param energythreshold: energythreshold is used to delete path segments in the transport network
...
def all_cal(filename_cif,moveion='Li',valenceofmoveion=1,energythreshold=None):
    bv_calculation(filename_cif, moveion=moveion, valenceofmoveion=valenceofmoveion, resolution=0.1)
