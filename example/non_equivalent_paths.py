...
if __name__ == "__main__":
    ...
    filename_CAVD = "LGPS/LGPS_origin.net"
    ...
    mep = get_non_equivalent_paths_between_latticesite(filename_CIF, filename_BVSE, filename_CAVD, energythreshold=1, moveion='Li')
    print(mep)
